...
<section id="product" class="bg-light mt-5">
   ...
   <div class="row my-5 align-items-center justify-content-center g-0">
    <div class="col-8 col-lg-4">
      <div class="card border-primary border-2" style="width:400px">
        <div class="card-body tex-center py-4 ">
            <a href="{{ isset($product) ? route('product.details', ['id' => $product->id]) : route('product.details', ['id' => 1]) }}">
    ...
    <div class="col-8 col-lg-4">
      <div class="card border-primary border-2" style="width:400px">
        <div class="card-body tex-center py-4">
            <a href="{{ isset($product) ? route('product.details', ['id' => $product->id]) : route('product.details', ['id' => 2]) }}">
    ...
    <div class="col-8 col-lg-4 ">
      <div class="card border-primary border-2" style="width:400px">
        <div class="card-body tex-center py-4">
             <a href="{{ isset($product) ? route('product.details', ['id' => $product->id]) :  route('product.details', ['id' => 3]) }}">
